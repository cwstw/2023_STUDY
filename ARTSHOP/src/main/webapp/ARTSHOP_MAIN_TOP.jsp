...
<html lang="en">
    <head>
        ...
        <title>ART#</title>
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="MYARTSHOP/IMAGES/assets/favicon.ico" />
        <!-- Bootstrap icons-->
                ...
                <div class="container px-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li class="nav-item"><a class="nav-link" href="ARTSHOP_MAIN.jsp">홈</a></li>
                            <li class="nav-item"><a class="nav-link" href="ARTSHOP_ABOUT.jsp">아트#</a></li>
