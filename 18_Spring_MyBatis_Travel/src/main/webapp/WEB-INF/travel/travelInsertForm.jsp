...
<form:form commandName="travel" action="insert.tv" method="post">
	...
	<input type="radio" name="style" value="크루즈" <c:if test="${travel.style.equals('크루즈')}">checked</c:if>>크루즈
	...
	<select name="price">
		...
		<option value="100~200" <c:if test="${travel.price.equals('100~200')}">selected</c:if>>100~200</option>
		<option value="200~300" <c:if test="${travel.price.equals('200~300')}">selected</c:if>>200~300</option>
		<option value="300~400" <c:if test="${travel.price.equals('300~400')}">selected</c:if>>300~400</option>
		<option value="400~500" <c:if test="${travel.price.equals('400~500')}">selected</c:if>>400~500</option>
	</select>
